...
AccountInfo::AccountInfo(AccountInfo& original_obj)
{
    account_id = original_obj.account_id;
    account_name = original_obj.account_name;
    account_money = original_obj.account_money;
}
